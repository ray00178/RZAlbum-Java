package com.rayzhang.android.rzalbum.itemdecoration;
...
public class RecycleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecycleItemDecoration(int dividerSize, @ColorInt int dividerColor) {
        mDividerSize = dividerSize;
        initPaint(dividerColor);
    }

    public RecycleItemDecoration(int dividerSize, @ColorInt int dividerColor, int linearMode) {
        mDividerSize = dividerSize;
